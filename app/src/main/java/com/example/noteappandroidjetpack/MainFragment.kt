...
import com.example.noteappandroidjetpack.databinding.MainFragmentBinding
...
class MainFragment : Fragment(), NotesListAdapter.ListItemListener {
    ...
    override fun onCreateView(
        ...
        setHasOptionsMenu(true)  // in case of fragment (not activity) you have to say this to add menu
        ...
        viewModel.notesList?.observe(viewLifecycleOwner, Observer {
            ...
            //Handle selected notes save instance in configuration changes
    ...
    override fun onItemSelectionChanged() {
        requireActivity().invalidateOptionsMenu() //reset options menu
    }

    override fun onCreateOptionsMenu(menu: Menu, inflater: MenuInflater) {
        val menuId =
            if (this::adapter.isInitialized &&
                    adapter.selectedNotes.isNotEmpty()) { // .isInitialized with lateinit vars
    ...
    override fun onSaveInstanceState(outState: Bundle) {
        if( this::adapter.isInitialized) {  // to check if obj is initialized theis::
